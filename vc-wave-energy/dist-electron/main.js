...
let je, R, G, ge, H, L, I, qe, le;
var zn = function(u, n) {
  je = String(u), R = "start", G = [], ge = 0, H = 1, L = 0, I = void 0, qe = void 0, le = void 0;
  do
    I = Sn(), $n[R]();
  while (I.type !== "eof");
...
function a() {
  const e = W();
  return e === `
` ? (H++, L = 0) : e ? L += e.length : L++, e && (ge += e.length), e;
}
const zu = {
  default() {
    switch (_) {
...
function S(e) {
  return _e(e === void 0 ? `JSON5: invalid end of input at ${H}:${L}` : `JSON5: invalid character '${Su(e)}' at ${H}:${L}`);
}
function Q() {
...
Data: ${t.data}`);
          break;
        case "SOT":
          q("start-wave"), console.log("main.ts >> Received SOT!");
          break;
        case "EOT":
